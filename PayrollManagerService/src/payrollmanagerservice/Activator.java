...
public class Activator implements BundleActivator {
	...
	public static Map<Integer, String[]> financialDetails = new HashMap<>();
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		serviceRegistration = bundleContext.registerService(SalaryCalculation.class.getName(), salaryCalculation, null);
		//
		...
		// "5000000"
		// );
		// salaryCalculation.employeeFinancialDetails(1, (float)100000,
		// (float)0.12, 2017, 03);
		//
		// salaryCalculation.employeeDetails(
		// 2,
		...
		// "345000"
		// );
		// salaryCalculation.employeeFinancialDetails(2, (float)10000,
		// (float)0.14, 2017, 03);
